...
void realizar_compra(Tcad_medicamento *estoque_medicamento[tam2],int ct_med){
    ...
    int cod=0,qt_prod=0,bus,op=-1,resp=0,achou=0;
...
void alterar_medicamento(Tcad_medicamento estoque_medicamentos[tam2],int ct_med){
...
int main()
{
    ...
    int op=0,ct_clientes=0,ct_medicamentos=0;
    //off-set
